...
async def to_code(config):
    ...
    cg.add_library("Bosch BSEC2 Library", "1.6.2400", "https://github.com/boschsensortec/Bosch-BSEC2-Library.git")
    cg.add_library("Bosch BME68x Library", "1.1.40407", "https://github.com/boschsensortec/Bosch-BME68x-Library.git")